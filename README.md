...
<div style="position: relative;">
  ...
  <div style="position: absolute; top: 35%; left: 50%; transform: translate(-60%, -50%); text-align: center; color: ; font-size: 25px; font-weight: bold;">
     An Evolutionary View on The Making of Good Films 🎬
    <div style="position: absolute; bottom: px; width: 100%; text-align: center; color: white; font-size: 15px; font-family: 'Times New Roman', serif;">
